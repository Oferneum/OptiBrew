...
function EmptyState() {
  return (
    <svg viewBox="0 0 120 120" fill="none" className="w-20 h-20">
      ...
      <circle cx="60" cy="60" r="12" fill="rgba(255,69,0,0.12)" />
      <circle cx="60" cy="60" r="6"  fill="rgba(255,69,0,0.35)" />
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-4 pb-24 space-y-4">
      ...
      <header className="pt-2">
        ...
        <h1 className="text-6xl font-black uppercase tracking-tighter leading-none bg-gradient-to-r from-[#FF4500] to-[#5D4037] bg-clip-text text-transparent">
          DIALED
        </h1>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={label} className="glass rounded-2xl p-3 text-center">
              ...
              <p className="readout text-2xl font-black mt-0.5 text-[#FF4500]">
                {value}
              </p>
            </div>
          ))}
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF4500]/10 to-[#FFC107]/8 border border-[#FF4500]/15 flex items-center justify-center flex-shrink-0">
